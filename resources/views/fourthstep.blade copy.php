        ...
        <div class="komponenenty">
            <div class="row naglowek">
                ...
                <div class="col-sm-8" style="padding-top:20px;">
                    <div class="napis">Krok 4: wybór pamięci Ram</div>
                </div>
                <div class="col-sm-2">
                    <div class="koszyk">
            ...
            <div class="komponenty-row">
                ...
                <aside class="komponenty-left">
                    <div class="ikona">
                        <img src="../images/ram.jpg" style="width:220px;height:170px;">
                    </div>
                    <hr class="hr">
                    <div class="filtry">
                        ...
                        @foreach($memorys as $memory)
                            <label class="filter-checkbox">
                                {{$memory->memory}} GB
                                <input class="filter" rel="{{$memory->memory}}mb"name="checkbox" type="checkbox">
                                <span class="znaczek-filtru"></span>
                            </label>
                        @endforeach
                      ...
                      @foreach($latencys as $latency)
                            <label class="filter-checkbox">
                                {{$latency->latency}} CL
                                <input class="filter" rel="{{$latency->latency}}cl" nname="checkbox" type="checkbox">
                                <span class="znaczek-filtru"></span>
                            </label>
                       @endforeach
                        <hr class="hr">
                      ...
                      @foreach($timings as $timing)
                            <label class="filter-checkbox">
                                 {{$timing->timing}} Mhz
                                <input class="filter" rel="{{$timing->timing}}" name="checkbox" type="checkbox">
                                <span class="znaczek-filtru"></span>
                            </label>
                        @endforeach
                        <hr class="hr">
